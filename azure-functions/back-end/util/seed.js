...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [type1, type2, type3, type4] = yield Promise.all([
    ...
    const [user1, user2] = yield Promise.all([
        User_1.default.create({
            ...
            password: yield bcrypt_1.default.hash('John123', 12),
            role: 'user',
        }),
        User_1.default.create({
            firstName: 'Jane',
            ...
            password: yield bcrypt_1.default.hash('Jane123', 12),
            role: 'user',
        }),
    ]);
    const [exercise1, exercise2, exercise3] = yield Promise.all([
